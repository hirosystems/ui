...
import { Colors, Text, Spacing } from './literal-types';
...
export interface TextStyleProp {
  textStyle?: ResponsiveStyleValue<Text> & SystemProps['textStyle'];
}
type Custom = TextStyleProp & ColorProps & SpaceProps;

export interface BoxProps extends Omit<SystemProps, keyof Custom>, Custom {}
