...
async function addLicense(packageData) {
  const license = `/** @license Blockstack UI v${packageData.version}
 *
...
`;
  await Promise.all(
    [
      "index.js",
      "es/index.js",
      "./umd/blockstack-ui.min.js",
      "./umd/blockstack-ui.js",
    ].map(async file => {
      try {
...
async function run() {
  try {
    ...
    await Promise.all(
      [
        // use enhanced readme from workspace root for `blockstack-ui`
        "./README.md",
