---
title: Theme
description: The foundation of the design system is the theme. It contains all of the design tokens which system props pull from.
images:
  large: /images/pages/theme.png
---

import { Box, Flex, Grid, useTheme } from '@stacks/ui';
...
box shadows, and more. Stacks UI is based on the
[Theme UI specification](https://system-ui.com/theme/).
...
map to one of Stacks UI's core theme. All of these keys can be replaced or
extended.
